...
class LikeAnimation : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_like_animation, container, false)
        likeImageView = view.findViewById(R.id.like)
        constraintLayout = view.findViewById(R.id.likeanimation)
    ...
    fun animateLike() {
        ...
        val scaleX = ObjectAnimator.ofFloat(likeImageView, View.SCALE_X, 0.2f, 1.0f)
        val scaleY = ObjectAnimator.ofFloat(likeImageView, View.SCALE_Y, 0.2f, 1.0f)
        val rotation = ObjectAnimator.ofFloat(likeImageView, View.ROTATION, -135f, 0f)
        ...
        val overRotation = ObjectAnimator.ofFloat(likeImageView, View.ROTATION, 15f)

        // Define the final rotation animation to return to the regular position
        val finalRotation = ObjectAnimator.ofFloat(likeImageView, View.ROTATION, 0f)
