...
class UserAdapter(context: Context, private val userIds: List<String>) : ArrayAdapter<String>(context, 0, userIds) {
    private val inflater = LayoutInflater.from(context)

    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val view = convertView ?: inflater.inflate(R.layout.user_list_item, parent, false)
